...
const HeroBanner = () => {
  return (
    <div className="relative h-[80vh] lg:h-[550px] flex justify-end w-full rounded-ds-16 mt-6 overflow-clip">
      <RiveComponent
      ...
      <Stack
        gap={32}
        className="absolute z-10 w-10/12 top-[10%] lg:max-w-lg h-fit lg:top-[100px] left-[10%] lg:left-auto lg:right-[10%]"
      >
        <h1 className="brandedText font-bold text-brand leading-[2.5rem] text-[2.5rem] md:leading-[4rem] md:text-[4rem] lg:leading-[4.5rem] lg:text-[4.5rem]">
