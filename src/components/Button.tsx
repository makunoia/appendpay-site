...
const TextButtonStyle = cva(
  "h-auto gap-1 active:bg-interface-selected-subtle",
  {
    variants: {
      style: {
        default: "",
        bare: "px-ds-2 py-0 hover:underline",
      },
      intent: {
...
const IconButtonStyle = cva("hover:shadow-button aspect-square", {
  variants: {
    size: {
      small: "text-caption p-ds-6 h-[1.625rem]",
      default: "text-body p-ds-10 h-9",
      large: "text-body-large p-ds-16 h-[3.125rem]",
    },
    intent: {
      default:
...
const Button = ({
  ...
  const ButtonStyle = cn(
    ...
    "flex items-center justify-center rounded-ds-8",
