...
const config: Config = {
  ...
  theme: {
    extend: {
      padding: {
        "ds-2": "var(--spacing-2px)",
        "ds-4": "var(--spacing-4px)",
        "ds-6": "var(--spacing-6px)",
        "ds-8": "var(--spacing-8px)",
        "ds-10": "var(--spacing-10px)",
        "ds-12": "var(--spacing-12px)",
        "ds-14": "var(--spacing-14px)",
        "ds-16": "var(--spacing-16px)",
        "ds-18": "var(--spacing-18px)",
        "ds-20": "var(--spacing-20px)",
        "ds-24": "var(--spacing-24px)",
        "ds-28": "var(--spacing-28px)",
        "ds-32": "var(--spacing-32px)",
        "ds-36": "var(--spacing-36px)",
        "ds-40": "var(--spacing-40px)",
        "ds-60": "var(--spacing-60px)",
      },
    ...
    borderRadius: {
      ...
      "ds-6": "var(--corner-6px)",
      "ds-8": "var(--corner-8px)",
      "ds-10": "var(--corner-10px)",
      "ds-12": "var(--corner-12px)",
      "ds-16": "var(--corner-16px)",
      "ds-24": "var(--corner-24px)",
      "ds-full": "var(--corner-rounded)",
    },
    ...
    boxShadow: {
      ...
      "surface-overlay-right": "4px 0px 12px 0px var(--shadow-surface-overlay)",
      "surface-overlay-left": "-4px 0px 12px 0px var(--shadow-surface-overlay)",
    },
    ...
    fontSize: {
      ...
      subheading: ["var(--font-size-subheading)", "var(--leading-subheading)"],
      ...
      "body-relaxed": ["var(--font-size-body)", "var(--leading-body-relaxed)"],
