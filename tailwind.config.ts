...
import twTypograhy from "@tailwindcss/typography";
...
const config: Config = {
  ...
  theme: {
    extend: {
      padding: {
        ...
        "mds-6": "var(--spacing-6)",
        "mds-8": "var(--spacing-8)",
        "mds-10": "var(--spacing-10)",
        "mds-12": "var(--spacing-12)",
        "mds-14": "var(--spacing-14)",
        "mds-16": "var(--spacing-16)",
        "mds-18": "var(--spacing-18)",
        "mds-20": "var(--spacing-20)",
        "mds-24": "var(--spacing-24)",
        "mds-28": "var(--spacing-28)",
        "mds-32": "var(--spacing-32)",
        "mds-36": "var(--spacing-36)",
        "mds-40": "var(--spacing-40)",
        "mds-60": "var(--spacing-60)",
      },
      ...
      borderRadius: {
        ...
        "mds-6": "var(--corner-6)",
        "mds-8": "var(--corner-8)",
        "mds-10": "var(--corner-10)",
        "mds-12": "var(--corner-12)",
        "mds-16": "var(--corner-16)",
        "mds-24": "var(--corner-24)",
        "mds-full": "var(--corner-rounded)",
      },
  ...
  plugins: [twContainerQueries, twTypograhy],
};
